<%@ Page Title="Register Admin" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="~/systemAdmin/Register_admin.aspx.cs" Inherits="Register_admin" %>
                             ...
                             <div class="row mt-3 ">
                                ...
                                <div class="col">
                                      <asp:DropDownList ID="year" class="form-control" runat="server" >  
                                        <asp:ListItem Value="" InitialValue="Unselectable Item">Acc to type</asp:ListItem>  
                                        <asp:ListItem>Mca</asp:ListItem>  
                                        <asp:ListItem>Vesit</asp:ListItem>  
