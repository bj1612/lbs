<%@ Page Title="Update Admin" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Update_admin.aspx.cs" Inherits="systemAdmin_Update_admin" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="bradcam_text text-center">
                        <h3 style="color:White; font-size:xx-large;font-family: 'Poppins', sans-serif;">Update Admin</h3>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="single_service active">
                                <div class="row justify-content-center">
                                    <div class="col-lg-12 col-md-12 col-xs-12 mt-3">
                                        <div class="row">
                                            <div class="col">
                                                <asp:DropDownList ID="AdminType" class="form-control" CssClass="form-control" runat="server" 
                                                    AutoPostBack="True" onselectedindexchanged="AdminType_SelectedIndexChanged">  
                                        ...
                                        <div class="row mt-3" runat="server" id="UniversityDiv">
                                            <div class="col">
                                                <asp:DropDownList ID="University" class="form-control" CssClass="form-control" runat="server" 
                                                    onselectedindexchanged="University_SelectedIndexChanged" AutoPostBack="True">
                                                    <asp:ListItem Value="0" Text="Select University"></asp:ListItem>
                                                </asp:DropDownList>  
                                            </div>
                                        </div>
                                        <div class="row mt-3" runat="server" id="InstituteDiv">
                                            <div class="col">
                                                <asp:DropDownList ID="Institute" class="form-control" CssClass="form-control" runat="server" AutoPostBack="True" onselectedindexchanged="Institute_SelectedIndexChanged">
                                                    <asp:ListItem Value="0" Text="Select Institute"></asp:ListItem>
                                                </asp:DropDownList>  
                                            </div>
                                        </div>
                                        <div class="row mt-3" runat="server" id="DepartmentDiv">
                                            <div class="col">
                                                <asp:DropDownList ID="Department" class="form-control" CssClass="form-control" runat="server" 
                                                    AutoPostBack="True" 
                                        ...
                                        <div class="row justify-content-center mt-5">
                                            <asp:Button class="btn boxed-btn4" CssClass="btn boxed-btn4" style="background: #ff3500;color: #fff;border: 1px solid #ff3500;" runat="server" id="UpdateButton" Enabled="false" Text="Update Admin">
                                            </asp:Button>
