<%@ Page Title="Add Department" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Add_department.aspx.cs" Inherits="systemAdmin_Add_department" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="bradcam_text text-center">
                        <h3 style="color:White;font-size:xx-large;">Add Institute</h3>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col">
                                            ...
                                            <asp:DropDownList ID="AvailableInstitute" class="form-control" runat="server" AutoPostBack="True" onselectedindexchanged="AvailableInstitute_SelectedIndexChanged">
                                            </asp:DropDownList>  
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col">
                                            <label for="AvailableDepartment" style="font-weight:bold;padding-left:10px;">Available Departments</label>
                                            <asp:DropDownList ID="AvailableDepartment" class="form-control" runat="server" AutoPostBack="True">
                                            </asp:DropDownList>  
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col">
                                            <asp:TextBox ID="DepartmentName" class="form-control" placeholder="Department name" runat="server" pattern="[A-Za-z ]+" required="true" title="Alphabets only"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col">
                                            <asp:DropDownList ID="University" class="form-control" runat="server" AutoPostBack="True" onselectedindexchanged="University_SelectedIndexChanged">  
                                    ...
                                    <div class="row mt-3">
                                        <div class="col">
                                            <asp:DropDownList ID="Institute" class="form-control" runat="server">  
