<%@ Page Title="Add Institute" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Add_institute.aspx.cs" Inherits="systemAdmin_Add_institute" %>
                        ...
                        <div class="single_service active">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col">
                                            <asp:TextBox ID="InstituteName" class="form-control" placeholder="Institute name" runat="server" pattern="[A-Za-z ]+" required="true" title="Alphabets only"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col">
