<%@ Page Title="Update Category" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="UpdateCategory.aspx.cs" Inherits="admin_UpdateCategory" MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="bradcam_text text-center">
                        <h3 style="color:White; font-size:xx-large;font-family: 'Poppins', sans-serif;">Update Category</h3>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div id="remove" class="tab-pane fade show active" role="tabpanel" aria-labelledby="remove-tab">
                                        <div class="row justify-content-center">
                                            <div class="col-lg-12 col-md-12 col-xs-12 mt-3">
                                                <div class="row">
                                                    <div class="col mt-3">
                                                        <label for="AvailableModerator" style="font-weight:bold;padding-left:10px;">Available Category</label>
                                                        <asp:DropDownList ID="AvailableCategory" class="form-control" runat="server" style="height:48px;font-size:18px;border:1px solid #e5e6e9;">
                                    ...
                                    <div id="add" class="tab-pane fade" role="tabpanel" aria-labelledby="add-tab">
                                        <div class="row justify-content-center">
                                            <div class="col-lg-12 col-md-12 col-xs-12 mt-3">
                                                <div class="row">
                                                    <div class="col mt-3">
                                                        <label for="OffDutyModerator" style="font-weight:bold;padding-left:10px;">Unavailable Category</label>
                                                        <asp:DropDownList ID="UnavailableCategory" class="form-control" runat="server" style="height:48px;font-size:18px;border:1px solid #e5e6e9;">
                                                            <asp:ListItem Value="Select Category" Text="Select Category"></asp:ListItem>
                                                        </asp:DropDownList>  
                                                    </div>
                                                </div>
